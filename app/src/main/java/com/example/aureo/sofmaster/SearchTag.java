...
public class SearchTag extends AsyncTask<String,Void,String> {
    Context context;
    Boolean dialog_true;
    Dialog dialog;
    AlertDialog alertDialog;

    SearchTag(Context ctx, Boolean dialog) {
        context = ctx;
        dialog_true = dialog;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://api.stackexchange.com/2.2/search?pagesize=20&order=desc&sort=relevance&tagged="+params[0]+"&site=stackoverflow";
    ...
    public SearchTag(AsyncResponse_Ler delegate){
